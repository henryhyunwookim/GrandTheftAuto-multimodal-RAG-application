...
# Absolute path to repository root (parent of 'scripts/' directory)
...
try:
    from src.rag_engine import get_logger
except ImportError:
...
# Checkpoint and cache file locations (anchored to repository root)
DESCRIPTION_CHECKPOINT_FILE: str = str(REPO_ROOT / "data" / "descriptions_checkpoint.json")
IMAGE_CACHE_FILE: str = str(REPO_ROOT / "data" / "image_embeddings_cache.npy")
CAPTION_CACHE_FILE: str = str(REPO_ROOT / "data" / "caption_embeddings_cache.npy")
...
def build_index(args: argparse.Namespace) -> None:
    ...
    """
    data_pickle_path = REPO_ROOT / 'data' / 'data_set.pkl'
    chroma_dir = REPO_ROOT / 'data' / 'chroma'
    chroma_dir.mkdir(parents=True, exist_ok=True)
    checkpoint_path = DESCRIPTION_CHECKPOINT_FILE
