...
# Ensure repository root is on sys.path so 'src' and modules resolve regardless of working directory
...
# ---------------------------------------------------------------------------
# Load environment variables from repo-root .env (overrides system defaults to ensure fresh keys)
